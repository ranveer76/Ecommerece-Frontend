...
import {
    ...
    selectFeaturedProductsFetchStatus,
...
export const ProductList = () => {
    ...
    const featuredProductsFetchStatus = useSelector(selectFeaturedProductsFetchStatus);
    const productFetchStatus = useSelector(selectProductFetchStatus);

    const wishlistItems = useSelector(selectWishlistItems);
    const wishlistItemAddStatus = useSelector(selectWishlistItemAddStatus);
    const wishlistItemDeleteStatus = useSelector(
        selectWishlistItemDeleteStatus
    );
    ...
    useEffect(() => {
        return () => {
            ...
            dispatch(resetFeaturedProductsFetchStatus());
        };
    }, [dispatch]);
        ...
        <>
            {productFetchStatus === 'pending' ? (
                ...
                <>
                    ...
                    <Stack mb={'3rem'}>
                        {!is600 && featuredProducts?.length > 0 && (
                            <Stack
                                sx={{
                                    width: '100%',
                                    height: is800
